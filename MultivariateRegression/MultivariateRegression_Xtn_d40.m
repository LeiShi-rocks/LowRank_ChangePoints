...
Para_apgl.Clambda = [0.6, 0.24, 0.2, 0.2, 0.2, 0.2]; % Gaussian, Cauchy, Lognormal

Para_l2.Clambda = [1.5, 1.5, 1.5, 1.5, 1.5, 1];
%tuningPara_l2.Lf = [2e4, 2e4, 2e4];

Para_shrink.Clambda = [0.5, 0.35, 0.35, 0.35, 0.35, 0.35];
Para_shrink.Ctau = [0.8, 0.8, 0.8, 1.5, 1.5, 1,5];

Para_l1.Clambda = [0.4, 0.4, 0.4, 0.35, 0.35, 0.35];
%tuningPara_l1.Lf = [3e4, 3e4, 3e4];

Para_wilcoxon.Clambda = [0.15, 0.15, 0.14, 0.14, 0.14, 0.14];
...
if save_flag
    ...
    save('Record_MR_small_tn_d40.mat', 'Record_MR_small_tn_d40');
end
