...
%% MR SCP large
clear;clc;
load('record_N_refit_CS_SCP_large_signal.mat'); % nr = nc = 50;
...
for N_ind = 1:3
    for method_ind = 1:4
        ...
        for iter = 1:100
            ...
            Theta_hat_1 = Theta_hat(:, 1:40);
            Theta_hat_2 = Theta_hat(:, 41:80);
...
labels = {'ML, 1500', 'ML, 2000', 'ML, 2500', 'VL, 1500', 'VL, 2000', 'VL, 2500'};
...
%% MR SCP large
clear;clc;
load('record_dim_refit_CS_SCP_large_signal.mat'); % nr = nc = 50;
% record_N = cell(4, 7, 3, num_iter);
% 4 methods: ours, LASSO, Oracle, NC
% Fnormsq_1, Fnormsq_2, tau_hat, obj_path, Delta_path, Theta_hat,
% Theta_star(in first round of running)
...
labels = {'ML, 20', 'ML, 35', 'ML, 50', 'VL, 20', 'VL, 35', 'VL, 50'};
boxplot([plot_vec_ML, plot_vec_VL], 'Labels', labels);
