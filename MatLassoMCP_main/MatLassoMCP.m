function [post_Theta_hat, post_tau_hat, post_rank, MCP_outInfo] = MatLassoMCP(y, X, threshold_var, Clambda_base, window_length, num_windows, cutoff,...
...
for current_window = 1:num_windows
    ...
    APG_opts_1.Clambda = Clambda_base;
...
for ind = 1:num_cps
    ...
    [~, tau_hat, ~, ~, ~] = MatLassoSCP(y, X, threshold_var, kappa_2, running_window, resolution_In_2, APG_opts_2);
