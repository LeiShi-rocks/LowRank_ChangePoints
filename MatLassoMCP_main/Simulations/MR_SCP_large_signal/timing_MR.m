...
for N_ind = 1:length(N_Cand)
    ...
    for iter = 1:num_iter
        ...
        if running_flag(1)
            ...
            record_N(1, N_ind, iter)  = elapsedtime;
        ...
        if running_flag(2)
            ...
            record_N(2, N_ind, iter)  = elapsedtime;
        ...
        if running_flag(3)
            ...
            record_N(3, N_ind, iter)  = elapsedtime;
        ...
        if running_flag(4)
            ...
            record_N(4, N_ind, iter)  = elapsedtime;
...
for dim_ind = 1:length(N_Cand)
    ...
    for iter = 1:num_iter
        ...
        if running_flag(1)
            ...
            record_dim(1, dim_ind, iter)  = elapsedtime;
        ...
        if running_flag(2)
            ...
            record_dim(2, dim_ind, iter)  = elapsedtime;
        ...
        if running_flag(3)
            ...
            record_dim(3, dim_ind, iter)  = elapsedtime;
        ...
        if running_flag(4)
            ...
            % store information
            record_dim(4, dim_ind, iter) = elapsedtime;
