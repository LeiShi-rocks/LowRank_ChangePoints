...
Para_apgl.Clambda = [0.2, 0.25, 0.3, 0.27, 0.3, 0.3]; % Gaussian, Cauchy, Lognormal

Para_shrink.Clambda = [0.4, 0.4, 0.6, 0.55, 0.65, 0.7];
Para_shrink.Ctau = 100.*[2.5, 2.5, 2.5, 2.5, 2.5, 2.5];

Para_l1.Clambda = [0.45, 0.3, 0.3, 0.3, 0.3, 0.3];
%tuningPara_l1.Lf = [3e4, 3e4, 3e4];

Para_wilcoxon.Clambda = [0.2, 0.2, 0.2, 0.2, 0.25, 0.25];
...
for designInd = 1 : 6
    ...
    for trial = 1 : niter
        ...
        [X, y, Theta_star] = DataGen(nr, nc, N, r, noise, 'MR', 'small', design(designInd));
...
if save_flag
    ...
    save('lowX.mat', 'Record_MR_small_Xtn_d40');
end
