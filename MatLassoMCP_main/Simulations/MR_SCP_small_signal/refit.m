...
load('record_N_MR_SCP_small_signal.mat');
...
if save_flag
    save('record_N_refit_MR_SCP_small_signal.mat', 'record_N_refit');
end


%% varying dimension
clear;clc;
load('record_dim_MR_SCP_small_signal.mat');
...
if save_flag
    save('record_dim_refit_MR_SCP_small_signal.mat', 'record_dim_refit');
end
