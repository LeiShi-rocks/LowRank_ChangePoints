...
Para_l2.Clambda = [0.4, 10, 10];
%tuningPara_l2.Lf = [2e4, 2e4, 2e4];

Para_shrink.Clambda = [0.3, 0.3, 0.4];
Para_shrink.Ctau = [2, 1.5, 1.5];
...
%disp(num2str(log(Record(:,1,:,3,10)*6400)/2))
%disp(num2str(log(Record(:,1,:,1,1)*6400)/2))
%disp(num2str(log(Record(:,1,2,2,:)*6400)/2))
%disp(num2str(log(Record(:,1,3,2,:)*6400)/2))
