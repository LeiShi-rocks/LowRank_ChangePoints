...
Para_apgl.Clambda = [0.6, 0.4, 0.4, 0.4, 0.38, 0.35]; % Gaussian, Cauchy, Lognormal

Para_l2.Clambda = [1.5, 1.5, 1.5, 1.5, 1.5, 1];
%tuningPara_l2.Lf = [2e4, 2e4, 2e4];

Para_shrink.Clambda = [0.8, 0.7, 0.7, 0.7, 0.65, 0.65];
Para_shrink.Ctau = [1, 1, 1, 1.5, 1.5, 1.5];

Para_l1.Clambda = [0.4, 0.4, 0.4, 0.4, 0.4, 0.5];
%tuningPara_l1.Lf = [3e4, 3e4, 3e4];

Para_wilcoxon.Clambda = [0.3, 0.3, 0.25, 0.27, 0.25, 0.25];
wilcoxonLf = [5e3 5e4 5e4 5e5 1e4 1e4];
